...
export class AuthService extends AbstractService {
  ...
  /*login(email, password) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http.get(apiUrl + "login", options).toPromise()
        .then(
          res => {
            loading.dismiss();
  ...
  updateProfileStatus(userProfile:any) {
    return this.callPostService(API_URL + '/users/updateProfileStatus', userProfile, "updateProfileStatus(userProfile)");
  }
